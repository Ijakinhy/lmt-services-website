    ...
    <div className="bg-black text-white min-h-screen">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-6">FUMIGATION SERVICES</h1>
          <p className="text-xl text-gray-300 mb-8 max-w-3xl mx-auto">
            Ensures consistent and uninterrupted fumigation, especially in industries, home and office operations.
          </p>
          <Button
            size="lg"
