...
export default function MushroomPro() {
...
<div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
  ...
  <div
    className={`relative transform transition-all duration-800 ease-out delay-200 ${isLoaded ? "translate-x-0 opacity-100" : "translate-x-8 opacity-0"} lg:order-1`}
  >
  ...
  <div
    className={`space-y-6 transform transition-all duration-800 ease-out ${isLoaded ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"} lg:order-2`}
  >
    <div className="space-y-2">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight">MUSHROOM PRODUCTIONS</h1>
    </div>
  </div>
</div>
      </div>
